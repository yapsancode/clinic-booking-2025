  ...
  return (
    <>
            ...
            <div className="flex items-center space-x-2 lg:space-x-3">
              ...
              >
                <div className="relative w-6 h-5">
                  <span className={`absolute left-0 w-6 h-0.5 bg-current rounded-full transition-all duration-300 ease-in-out ${isOpen ? 'rotate-45 top-2' : 'top-0'
                    }`}></span>
                  <span className={`absolute top-2 left-0 w-6 h-0.5 bg-current rounded-full transition-all duration-300 ease-in-out ${isOpen ? 'opacity-0 scale-0' : 'opacity-100 scale-100'
                    }`}></span>
                  <span className={`absolute left-0 w-6 h-0.5 bg-current rounded-full transition-all duration-300 ease-in-out ${isOpen ? '-rotate-45 top-2' : 'top-4'
                    }`}></span>
                </div>
      ...
      <div className={`lg:hidden fixed inset-0 z-40 transition-all duration-300 ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'
        ...
        {/* Slide-in Menu */}
        <div className={`absolute top-16 left-0 right-0 bg-white shadow-2xl transition-all duration-300 ease-out ${isOpen ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'
          }`}>
          <div className="max-h-[calc(100vh-4rem)] overflow-y-auto">
            <div className="p-4 space-y-1">
              ...
              <Link
                href="/"
                className={`flex items-center px-4 py-3.5 font-medium rounded-xl transition-all duration-200 active:scale-98 touch-manipulation ${isActive('/')
                    ? 'text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 active:bg-gray-100'
                  }`}
                onClick={() => setIsOpen(false)}
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-colors ${isActive('/') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
              ...
              <a
                href="/doctors"
                className={`flex items-center px-4 py-3.5 font-medium rounded-xl transition-all duration-200 active:scale-98 touch-manipulation ${isActive('/doctors')
                    ? 'text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 active:bg-gray-100'
                  }`}
                onClick={() => setIsOpen(false)}
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-colors ${isActive('/doctors') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="/services"
                className={`flex items-center px-4 py-3.5 font-medium rounded-xl transition-all duration-200 active:scale-98 touch-manipulation ${isActive('/services')
                    ? 'text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 active:bg-gray-100'
                  }`}
                onClick={() => setIsOpen(false)}
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-colors ${isActive('/services') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="/about"
                className={`flex items-center px-4 py-3.5 font-medium rounded-xl transition-all duration-200 active:scale-98 touch-manipulation ${isActive('/about')
                    ? 'text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 active:bg-gray-100'
                  }`}
                onClick={() => setIsOpen(false)}
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-colors ${isActive('/about') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="/contact"
                className={`flex items-center px-4 py-3.5 font-medium rounded-xl transition-all duration-200 active:scale-98 touch-manipulation ${isActive('/contact')
                    ? 'text-blue-600 bg-gradient-to-r from-blue-50 to-blue-100 shadow-sm'
                    : 'text-gray-700 hover:bg-gray-50 active:bg-gray-100'
                  }`}
                onClick={() => setIsOpen(false)}
              >
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 transition-colors ${isActive('/contact') ? 'bg-blue-100' : 'bg-gray-100'
                  }`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
